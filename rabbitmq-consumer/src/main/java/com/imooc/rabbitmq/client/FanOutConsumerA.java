...
public class FanOutConsumerA {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //  创建队列
        AMQP.Queue.DeclareOk fanoutQueueA = channel.queueDeclare("fanout_queue_a", true, false, false, null);
        ...
        DefaultConsumer defaultConsumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("fanout_queue_a body  =  " + new String(body));
            }
        };

        //  信道 创建消费者 绑定队列和消费者的关系 监听队列消费消息
        channel.basicConsume("fanout_queue_a", true, defaultConsumer);
